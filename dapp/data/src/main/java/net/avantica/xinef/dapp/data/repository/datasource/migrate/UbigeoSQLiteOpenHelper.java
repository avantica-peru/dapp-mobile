...
public class UbigeoSQLiteOpenHelper extends SQLiteOpenHelper {

    public UbigeoSQLiteOpenHelper(Context context) {
    ...
    private void populateUbigeo(SQLiteDatabase db) {
        ...
        db.execSQL(huancavelica);

        String huanuco = table +
                "('10', '00', '00', 'HUANUCO'),"+
                "('10', '01', '00', 'HUANUCO'),"+
                "('10', '01', '01', 'HUANUCO'),"+
                "('10', '01', '02', 'AMARILIS'),"+
        ...
        db.execSQL(laLibertad);

        String lambayeque = table +
                "('14', '00', '00', 'LAMBAYEQUE'),"+
                "('14', '01', '00', 'CHICLAYO'),"+
                "('14', '01', '01', 'CHICLAYO'),"+
                "('14', '01', '02', 'CHONGOYAPE'),"+
        ...
        db.execSQL(madreDeDios);

        String moquegua = table +
                "('18', '00', '00', 'MOQUEGUA'),"+
